...
export default function Header() {
  ...
  const categories = [
    "All", "Alexa Skills", "Amazon Devices", "Amazon Fashion", "Amazon Fresh", "Amazon Pharmacy",
    "Appliances", "Apps & Games", "Audible Audiobooks", "Baby", "Beauty", "Books",
    "Car & Motorbike", "Clothing & Accessories", "Computers & Accessories", "Deals",
    "Electronics", "Furniture", "Garden & Outdoors", "Gift Cards", "Grocery & Gourmet Foods",
    "Health & Personal Care", "Home & Kitchen", "Jewellery", "Kindle Store", "Luggage & Bags",
    "Movies & TV Shows", "Music", "Musical Instruments", "Office Products", "Pet Supplies",
    "Prime Video", "Shoes & Handbags", "Software", "Sports, Fitness & Outdoors",
    ...
    <>
        ...
        <div className="nav-belt">
          ...
          <div className="nav-right">
            <div className="nav-item nav-lang">
              ...
              <span className="nav-item-line2">EN</span>
            </div>

            {user ? (
              <div className="nav-item" onClick={logout}>
                <span className="nav-item-line1">Hello, {user.name}</span>
                <span className="nav-item-line2">Sign Out ▾</span>
              </div>
            ) : (
      ...
      <div className="sub-nav">
        <div className="sub-nav-inner">
          <div className="sub-nav-item sub-nav-all"><span className="hamburger">☰</span> All</div>
