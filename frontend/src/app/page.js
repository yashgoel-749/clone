            ...
            <div className="carousel-section">
              ...
              <div className="carousel-viewport">
                <div className="carousel-track-scroll">
                  ...
                  <Link href="/product/harley-3" className="carousel-item"><img src="/image/71vwd_zpefl._ac_sy200_.jpg" alt="Harley Orange" /><div className="carousel-item-title">HARLEY-DAVIDSON X440 S Baja Orange</div><div className="carousel-item-price">₹2,29,500</div></Link>
